...
if(isset($_POST["addCart"])){
    ...
    $sqlt = "INSERT INTO `categories`(`cname`) VALUES ('$cname')";
     
        $resulte = mysqli_query($conn,$sqlt);
        if($resulte){   
            header('location: categories.php');
          }else{
            die('fail to insert category');
              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" action="" method="POST" enctype="multipart/form-data" >
                    <div class="mb-3">
                      <input type="text" name="cname" required class="form-control form-control-lg" placeholder="Category" aria-label="Email">
                    </div>
                    <div class="text-center">
                      <button type="submit" name="addCart" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Add Category</button>
                    </div>
                  </form>
                </div>
              </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            while($row = mysqli_fetch_assoc($result)){
                  ...
                  <tr>
                  <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $row ['cid'] ?></p>
                  ...
                  <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="<?php echo 'cat/'.$row ['cimg'] ?>" class="avatar avatar-lg me-3" alt="user1">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row ['cname'] ?></h6>
