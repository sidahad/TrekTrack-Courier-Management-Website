            ...
            <div class="card mb-4">
              ...
              while($row = mysqli_fetch_assoc($result)){
                    ...
                    <td>
                        ...
                        <td><a href="deletecategory.php?id=<?php echo $row['cid'] ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="delete category">DELETE
                        </a></td>
